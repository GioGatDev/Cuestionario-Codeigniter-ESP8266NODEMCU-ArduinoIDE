<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
         <div class="modal-header">
            <h3 align="justify"><span class="label btn-color2 qid">3</span><br><br>Los aparatos eléctricos como la televisión, la computadora, cargadores de celular, etc. Consumen electricidad cuando están enchufados pero no se están usando.</h3>
         </div>
